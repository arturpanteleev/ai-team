...
> **⚠️ Исторический документ.** Срез: 2026-07-20. С тех пор реализовано,
> как минимум: isolated candidate worktree (C-02), exact per-subject
...
> и более свежий `TECHNICAL_AUDIT_2026-08-05.html`. Разделы про OS-sandbox
