# ci-parity-check-import Specification

## Purpose
Импорт ограниченного объяснимого набора checks из реального CI проекта без исполнения произвольного YAML, с детерминированным SHA-256 fingerprint эффективного suite.
## Requirements
