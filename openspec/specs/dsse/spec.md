...
## Purpose
Authenticity поверх integrity: DSSE-envelope (ed25519, stdlib-only, PAE) для подписи bundle digest в export/gate и fail-closed верификация по публичному ключу.
## Requirements
