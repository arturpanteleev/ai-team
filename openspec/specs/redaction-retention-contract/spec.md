# redaction-retention-contract Specification

## Purpose
Сканер секретов по evidence, fail-closed блокер export'а, классификация полей и настраиваемый retention как технический housekeeping-контракт (без обещаний compliance).
## Requirements
