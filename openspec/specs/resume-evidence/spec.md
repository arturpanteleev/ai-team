# resume-evidence Specification

## Purpose
Fail-closed верификация evidence перед resume: манифесты, снапшоты config/workflow, hash-chain событий; отказ со стабильным reason-кодом и записью resume_blocked.
## Requirements
