...
Unified verification pass — агент verifier проверяет Acceptance Criteria, делает self-review diff и проверяет DoD checklist.
...
Verifier MUST выполнить self-review итогового candidate по controller-owned
workspace digest, changed paths, patch SHA-256 и actual typed check evidence.
